...
def mat2npy_train():
    mat = io.loadmat('data/all_all_new_train.mat')  # 读取.mat的信息//'pro_data_tri.mat' 'pro_data' 'predot'

    np.save('data/npy/all_all_train.npy', mat['Data_final'])  # 二进制保存


def mat2npy_test():
    mat = io.loadmat('data/all_4_6_test.mat')  # 读取.mat的信息//'pro_data_tri.mat' 'pro_data' 'predot'

    np.save('data/npy/all_4_6_test.npy', mat['Data_final'])  # 二进制保存
